...
from DualCycle import DualCycle
from Air import *
...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.dual = DualCycle(p_initial=101325, v_cylinder=0.001, t_initial=300, compression_ratio=18, cutoff_ratio=1.2, pressure_ratio=1.5)  # Example default values
